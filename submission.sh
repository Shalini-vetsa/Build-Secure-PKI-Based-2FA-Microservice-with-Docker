#!/bin/bash
repo_url=https://github.com/Shalini-vetsa/Build-Secure-PKI-Based-2FA-Microservice-with-Docker
...
echo "Docker image URL for evaluation: vetsashalini/build-secure-pki-based-2fa-microservice-with-docker-app:latest"
echo "Docker Hub link: https://hub.docker.com/r/vetsashalini/build-secure-pki-based-2fa-microservice-with-docker-app"